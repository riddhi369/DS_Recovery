...
class IAMHandler(base.BaseRestHandler):
    def handleEdit(self, confInfo):
        ...
        super(IAMHandler, self).handleEdit(confInfo)  # pylint: disable=super-with-arguments
        self._append_to_summary()

    def handleCreate(self, confInfo):
        """Called when user invokes the "create" action."""
        super(IAMHandler, self).handleCreate(confInfo)  # pylint: disable=super-with-arguments
        self._append_to_summary()
