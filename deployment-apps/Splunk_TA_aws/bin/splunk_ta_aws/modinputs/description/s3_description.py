...
#
"""
File for S3 description of description input
"""
...
def s3_buckets(config):
    """Yields S3 buckets."""
    s3_client = desc.BotoRetryWrapper(
            ...
            for operation in [
                ...
                try:
                    ...
                    if (
                        ...
                        and response["LocationConstraint"] is None
                    ):
